...
select IDEmpregado as ID,
	   ...
	   (Salario + Comissao) as [Renda Anual]
	from Empregado;

-- Faça uma consulta que liste todos os empregados que tenham o salário anual 
-- seja inferior a R$ 18500 ou que tenham o cargo de Atendente. Projetar as seguintes colunas:
