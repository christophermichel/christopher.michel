...
public class SaintTest {
    ...
    public void vestirArmaduraDeixaArmaduraVestida() {
        ...
        Saint hyoga = new Saint("Hyoga", capricornio, Genero.NAOINFORMADO);
    ...
    Saint saori = new Saint("Saori", new Armadura("Cisne", Categoria.OURO), Genero.NAOINFORMADO);
    assertEquals(false, saori.getArmaduraVestida());
}

    @Test
    public void aoCriarSaintGeneroENaoInformado() {
    Saint shaka = new Saint("Shaka", new Armadura("Virgem", Categoria.BRONZE), Genero.NAOINFORMADO);
