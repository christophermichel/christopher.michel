...
import br.com.crescer.aula01.StringUtils;
import br.com.crescer.aula01.TemaString;
...
public class Chat {
    ...
    private static final StringUtils STRING_UTILS = new TemaString();
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula.txt", "@christopher"};
        }
